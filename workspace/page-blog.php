...
while (have_posts()) : the_post();?>
               ...
               <?php } else { ?>
                ...
                <div class="post_content">
                    ...
                    <div class="single_metainfo"><a class="comm_date updated"><?php the_time( get_option('date_format') ); ?></a><?php if(of_get_option('dissauth_checkbox') == "0"){ ?>  <a class="meta_auth"><?php the_author(); ?></a><?php } ?>
                    <?php edit_post_link(); ?>
                    </div>
                    <?php the_excerpt(); ?> 
